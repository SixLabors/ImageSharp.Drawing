...
public partial class DrawingCanvasTests
{
        ...
        where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        canvas.Fill(new Rectangle(22, 16, 188, 118), Brushes.Solid(Color.Crimson.WithAlpha(0.8F)));
        canvas.DrawEllipse(Pens.Solid(Color.Gold, 5), new PointF(128, 80), new SizeF(140, 90));

        canvas.Clear(new Rectangle(56, 36, 108, 64), Brushes.Solid(Color.LightYellow.WithAlpha(0.45F)));
        IPath clearPath = new EllipsePolygon(new PointF(178, 80), new SizeF(74, 56));
        canvas.Clear(clearPath, Brushes.Solid(Color.Transparent));
        ...
        where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        canvas.Fill(new Rectangle(0, 0, 320, 200), Brushes.Solid(Color.MidnightBlue.WithAlpha(0.95F)));
        canvas.Fill(new Rectangle(26, 18, 268, 164), Brushes.Solid(Color.Crimson.WithAlpha(0.78F)));
        ...
        canvas.Clear(new Rectangle(40, 24, 108, 72), Brushes.Solid(Color.MediumPurple.WithAlpha(0.72F)));
        canvas.Clear(new Rectangle(172, 96, 110, 70), Brushes.Solid(Color.LightSeaGreen.WithAlpha(0.8F)));
        canvas.Clear(new EllipsePolygon(new PointF(164, 98), new SizeF(74, 48)), Brushes.Solid(Color.Transparent));
