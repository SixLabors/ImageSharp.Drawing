...
/// <summary>
/// Maps public WebGPU texture format identifiers to Silk.NET texture formats and back.
/// </summary>
internal static class WebGPUTextureFormatMapper
{
    /// <summary>
    /// Converts a public WebGPU texture format identifier to the corresponding Silk.NET texture format.
    /// </summary>
    ...
    /// <summary>
    /// Converts a Silk.NET texture format to the corresponding public WebGPU texture format identifier.
    /// </summary>
    /// <param name="textureFormat">The Silk.NET texture format.</param>
