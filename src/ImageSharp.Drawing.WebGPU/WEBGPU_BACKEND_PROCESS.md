...
- [`WEBGPU_RASTERIZER.md`](d:/GitHub/SixLabors/ImageSharp.Drawing/src/ImageSharp.Drawing.WebGPU/WEBGPU_RASTERIZER.md)
  Explains the staged scene pipeline. Topics include parallel scene encoding, packed formats, planning, resources, path lowering, rasterization, retries, chunking, and submission.
