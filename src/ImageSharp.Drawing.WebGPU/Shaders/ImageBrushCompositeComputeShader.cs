...
internal static class ImageBrushCompositeComputeShader
{
    ...
    public static ReadOnlySpan<byte> Code =>
        ...
        @group(0) @binding(1)
        var<storage, read> instance: ImageBrushCompositeData;
        ...
        fn sample_brush(params: ImageBrushCompositeData, destination_x: i32, destination_y: i32) -> vec4<f32> {
            if (params.image_region_width <= 0 || params.image_region_height <= 0) {
                return vec4<f32>(0.0, 0.0, 0.0, 0.0);
            }
        ...
        fn cs_main(@builtin(global_invocation_id) global_id: vec3<u32>) {
            ...
            let brush = sample_brush(params, destination_pixel_x, destination_pixel_y);
