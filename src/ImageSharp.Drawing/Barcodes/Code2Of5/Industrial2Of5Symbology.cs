...
/// <summary>
/// The Industrial 2 of 5 symbology, also called Code 25, which Identicon Corporation and Computer
/// Identics Corporation introduced in 1971. No published standard defines it. It carries the digits 0
/// to 9, each in five bars of which two are wide, and the spaces carry no data. A symbol carries a start
...
/// </para>
/// </summary>
public sealed class Industrial2Of5Symbology : BarcodeSymbology
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Industrial2Of5Symbology"/> class.
    /// </summary>
    public Industrial2Of5Symbology()
    ...
    /// validates it.
    /// </param>
    public Industrial2Of5Symbology(CheckCharacterMode checkDigit)
    ...
    /// </param>
    public Industrial2Of5Symbology(CheckCharacterMode checkDigit, bool printCheckDigit)
    {
    ...
    internal override BarcodeSymbol Encode(string text, BarcodeOptions options)
        => Code2Of5Encoder.Encode(text, options, Code2Of5Variant.Industrial, this.CheckDigit, this.PrintCheckDigit);
}
